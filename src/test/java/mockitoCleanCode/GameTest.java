package mockitoCleanCode;

import org.example.mockitoCleanCode.Game;
...
@RunWith(MockitoJUnitRunner.class) // le decimos a la clase que va a utilizar Mockito
public class GameTest {
    ...
    @InjectMocks //le indicamos que va a ser la clase principal para hacer los test
    private Game game;

    @Mock //indica que el objeto scanner estará dentro de la clase Game
    Scanner scanner;
